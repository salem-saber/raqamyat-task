...
#[AsCommand(name: 'apikey:generate')]
class ApiKeyGenerateCommand extends Command
{
     ...
     * @deprecated
     */
    protected static $defaultName = 'apikey:generate';
    ...
    {
        $currentKey = $this->laravel['config']['app.api_key'];
    ...
    {
        $escaped = preg_quote('='.$this->laravel['config']['app.api_key'], '/');
